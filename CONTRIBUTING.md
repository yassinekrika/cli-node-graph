# Contributing to cli-node-graph
...
# Analyze a project
pnpm run dev analyze ./tests/fixtures/sample-project

# Export graph
pnpm run dev export ./tests/fixtures/sample-project --format reactflow -o graph.json

# Detect cycles
pnpm run dev cycles ./tests/fixtures/sample-project

# Impact analysis
pnpm run dev impact UserService ./tests/fixtures/sample-project

# Statistics
pnpm run dev stats ./tests/fixtures/sample-project
```
